...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Image Debulrring using C2F-DFT')

    # parser.add_argument('--input_dir', default='/home/fgw/Desktop/ml/C2F-DFT-main/Deblurring/Datasets/test', type=str, help='Directory of validation images')
    # parser.add_argument('--result_dir', default='/home/fgw/Desktop/ml/C2F-DFT-main/Deblurring/results_fine/', type=str, help='Directory for results')
    # parser.add_argument('--weights', default='/home/fgw/Desktop/ml/C2F-DFT-main/experiments/Deblurring_C2F-DFT_Fine/models/net_g_latest.pth', type=str, help='Path to weights')
    parser.add_argument('--input_dir', default='/home/fgw/Desktop/ml/C2F-DFT-main/Deraining/Datasets/test', type=str,
                        help='Directory of validation images')
    parser.add_argument('--result_dir', default='/home/fgw/Desktop/ml/C2F-DFT-main/Deraining/results_fine', type=str,
                        help='Directory for results')
    parser.add_argument('--weights',
                        default='/home/fgw/Desktop/ml/C2F-DFT-main/experiments/Deraining_C2F-DFT_Fine_archived_20240624_213809/models/net_g_latest.pth',
                        type=str, help='Path to weights')

    args = parser.parse_args()

    ####### Load yaml #######
    yaml_file = '/home/fgw/Desktop/ml/C2F-DFT-main/Deblurring/Options/Deblurring_C2F-DFT_Fine.yml'
    import yaml
