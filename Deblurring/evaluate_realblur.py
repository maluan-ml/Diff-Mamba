...
for dataset in datasets:
    ...
    # file_path = os.path.join('/home/fgw/Desktop/ml/C2F-DFT-main/Deblurring/results_fine', dataset)
    # gt_path = os.path.join('/home/fgw/Desktop/ml/C2F-DFT-main/Deblurring/Datasets', 'test', dataset, 'target')
    file_path = os.path.join('/home/fgw/Desktop/ml/C2F-DFT-main/Deraining/results_fine', dataset)
    gt_path = os.path.join('/home/fgw/Desktop/ml/C2F-DFT-main/Deraining/Datasets', 'test', dataset, 'target')
